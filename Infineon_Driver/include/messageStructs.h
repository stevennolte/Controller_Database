...
struct __attribute__ ((packed)) Log_t{
    ...
    uint8_t can1State : 8;
    uint16_t row0FreqCmd : 16;
    uint16_t row0DutyCmd : 16;
    uint16_t row0CurrentReading : 16;
    uint16_t row1FreqCmd : 16;
    uint16_t row1DutyCmd : 16;
    uint16_t row1CurrentReading : 16;
  ...
  struct __attribute__ ((packed)) Log2_t{
