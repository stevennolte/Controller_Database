...
class BLEIPReceiver {
public:
    BLEIPReceiver(const char* deviceName, const char* serviceUUID, const char* ipCharacteristicUUID, const char* apStateCharacteristicUUID, const char* enabledStateCharacteristicUUID);
    void begin();
