...
void updateDebugVars() {
  ...
  debugVars.push_back("Press Mon State: " + String(pressMon.controlState));
  debugVars.push_back("Relay State: " + String(relayctrl.controlState));
...
void loop(){
  ...
  if (pressMon.controlState == 1){
    relayctrl.controlState = 1;
  }
  delay(10);
